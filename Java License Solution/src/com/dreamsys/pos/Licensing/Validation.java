package com.dreamsys.pos.Licensing;

public class Validation {
	
private String key ="SERIALKEYWORD";
	
	public boolean Validate(String customerCode,String serialKey){
		...
		serialKey= serialKey.substring(2, 10);
		System.out.println(serialKey +" is serial key");
		
		
	decrSerial =this.decipher(serialKey, key);
     System.out.println(decrSerial);
	if(decrSerial.equals(customerCode)){
